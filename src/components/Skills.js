...
const Skill = ({name,x,y})=>{
    return(
<motion.div className=' absolute flex items-center justify-center bg-dark rounded-full font-semibold text-light shadow-dark cursor-pointer py-3 px-6' 
...
const Skills = () => {
  return (
    ...
    <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight'>
        <motion.div className='flex items-center justify-center bg-dark rounded-full font-semibold text-light p-8 shadow-dark cursor-pointer' 
        whileHover={{scale:1.05}}
